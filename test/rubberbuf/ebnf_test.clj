(ns rubberbuf.ebnf-test
  ...
  (:require [rubberbuf.ebnf :refer [proto2-ebnf proto3-ebnf protoE-ebnf proto-version-ebnf textformat-ebnf]]
            [rubberbuf.util :refer [loader]]
            [clojure.test :refer [is deftest run-tests]]))

(def p2 (loader "resources/ebnf/proto2.ebnf"))
(def p3 (loader "resources/ebnf/proto3.ebnf"))
(def pe (loader "resources/ebnf/protoE.ebnf"))
(def pv (loader "resources/ebnf/proto-version.ebnf"))
