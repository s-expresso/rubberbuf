...
(defn write-ebnf-cljc [& opts] ; dummy opts for keyword args supplied via clj -X
  (let [p2 (escape-ebnf (slurp "resources/ebnf/proto2.ebnf"))
        ...
        pv (escape-ebnf (slurp "resources/ebnf/proto-version.ebnf"))
        pe (escape-ebnf (slurp "resources/ebnf/protoE.ebnf"))
        ...
        ebnf-cljc (-> cljc-template
                      ...
                      (clojure.string/replace-first #"<PROTO-VERSION>" pv)
                      (clojure.string/replace-first #"<PROTOE>" pe)
